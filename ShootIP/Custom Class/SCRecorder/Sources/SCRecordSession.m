...
NSString * const SCRecordSessionSegmentFilenameKey = @"Video.mov";
...
//        }
        ...
        NSArray *segments = [dictionaryRepresentation objectForKey:SCRecordSessionSegmentsKey];
        for (NSDictionary *segmentDictRepresentation in segments) {
            SCRecordSessionSegment *segment = [[SCRecordSessionSegment alloc] initWithDictionaryRepresentation:segmentDictRepresentation directory:SCRecordSessionDocumentDirectory];
...
//        _identifier = [NSString stringWithFormat:@"%@-", [SCRecordSession newIdentifier:12]];
        ...
        _identifier = [NSString stringWithFormat:@"Video"];
...
//        NSString *filename = [NSString stringWithFormat:@"%@SCVideo.%d.%@", _identifier, _currentSegmentCount, extension];
        NSString *filename = [NSString stringWithFormat:@"%@.%@", _identifier, extension];
...
//        NSString *filename = [NSString stringWithFormat:@"%@SCVideo-Merged.%@", _identifier, fileExtension];
        NSString *filename = [NSString stringWithFormat:@"%@.%@", _identifier, fileExtension];
