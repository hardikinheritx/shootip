...
- (NSString *)googleURLString {
    NSMutableString *url = [NSMutableString stringWithFormat:@"https://maps.googleapis.com/maps/api/place/queryautocomplete/json?input=%@&sensor=%@&types=address&key=%@",
    ...
    if (location.latitude != -1) {
        [url appendFormat:@"&location=%f,%f", 23.0300, 72.5800];
    }
